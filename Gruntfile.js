// Generated on 2015-03-25 using generator-jekyllrb 1.4.1
'use strict';
...
//            '<%= yeoman.dist %>/img/**/*.{gif,jpg,jpeg,png,svg,webp}',
    ...
    shell: {
      target: {
        command: 'rsync -e "/usr/bin/ssh"  -av dist/ harpar16@harshadparanjape.com:~/harshadparanjape.com/'
      }
    },
    autoshot: {
      default_options: {
        options: {
          ...
          remote: {
            files: [
              { src: "http://harshadparanjape.com", dest: "remote_index.png", delay: "100" },
            ]
          },
          local: {
            path: './dist/',
            port: 8080,
            files: [
              { src: "index.html", dest: "local_index.png" },
            ]
          },
          viewport: [
            '1920x1080',
